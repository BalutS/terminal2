...
import org.unimag.controlador.ConductorControladorGrabar;
...
public class VistaConductorCrear extends StackPane {
    ...
    private void guardarConductor() {
        ...
        if (formularioCompleto()) {
            ...
            dto.setCedulaConductor(txtCedula.getText());
            dto.setNombreConductor(txtNombre.getText());
            dto.setEdadConductor(Integer.parseInt(txtEdad.getText()));
            dto.setGeneroConductor(rbMasculino.isSelected());
