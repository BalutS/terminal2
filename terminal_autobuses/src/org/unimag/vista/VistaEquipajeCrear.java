...
import org.unimag.controlador.EquipajeControladorGrabar;
...
public class VistaEquipajeCrear extends StackPane {
    ...
    private void crearFormulario() {
        ...
        miGrilla.add(lblPeso, 0, 1);

        txtPeso = new TextField();
        txtPeso.setPromptText("Digita el peso");
        GridPane.setHgrow(txtPeso, Priority.ALWAYS);
        txtPeso.setPrefHeight(ALTO_CAJA);
        miGrilla.add(txtPeso, 1, 1);
        ...
        Button btnGrabar = new Button("Grabar Equipaje");
    ...
    private void guardarEquipaje() {
        ...
        if (formularioCompleto()) {
            ...
            dto.setPesoEquipaje(Double.parseDouble(txtPeso.getText()));
