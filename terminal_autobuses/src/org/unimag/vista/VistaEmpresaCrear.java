...
import org.unimag.controlador.EmpresaControladorGrabar;
...
public class VistaEmpresaCrear extends StackPane {
    ...
    // *************************************************************************
    public VistaEmpresaCrear(Stage esce, double ancho, double alto) {
    ...
    private void crearFormulario() {
        ...
        txtNombreEmpresa.setPromptText("Digita el nombre de la empresa");
        ...
        // *********************************************************************
        Label lblImagen = new Label("Imagen de la empresa");
